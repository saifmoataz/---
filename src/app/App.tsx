...
const TESTIMONIALS = [
  {
    name: "Nada yousef",
    quote: "Very hospitable staff & professional service! 💯 ...",
  },
  {
    name: "Mohamed Elsafi",
    quote: "Great experience overall. The shop is clean, the barbers are skilled, and the service is on point. Big thanks to the manager for running the place so professionally. Highly recommended.",
  },
  {
    name: "ehab maghewry",
    quote: "A very classy place with the highest level of cleanliness and excellent customer service from the moment a customer arrives until they leave. I thank Mr. Mustafa for choosing such wonderful people to work with him.",
  },
];
    ...
    <div className="bg-[#0a0a0a] text-white min-h-screen overflow-x-hidden font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-sm border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <a href="#" className="text-[#C9A84C] font-display text-lg tracking-[0.1em] uppercase">
            صالون مصطفي الفا - زهراء المعادي
          </a>
      ...
      <section className="relative min-h-screen flex items-end pb-20 pt-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6 w-full">
          ...
          <h1 className="font-display text-[clamp(2.5rem,7vw,5rem)] leading-[0.92] mb-8 tracking-tight max-w-4xl" dir="rtl">
            صالون مصطفي الفا
            <br />
            <span className="text-[#C9A84C] italic">زهراء المعادي</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              <p className="text-white/50 leading-relaxed mb-5 font-light">
                صالون مصطفي الفا started with a single chair, a straight razor, and a
            ...
            <div className="relative bg-[#111]">
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-[#0a0a0a]/90 to-transparent p-8 pt-20">
                ...
                <p className="font-display text-xl">مصطفي الفا</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="hours" className="py-24 md:py-36 border-t border-[#C9A84C]/15">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          ...
          <div className="border-l border-[#C9A84C]/30 pl-8 md:pl-12">
            <p className="font-display text-[clamp(1.8rem,4vw,3rem)] text-[#C9A84C]">12 PM – 12 AM</p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex justify-center items-start gap-3 text-white/50 text-base mb-10">
              ...
              <a href="https://maps.app.goo.gl/z3Yu1gTyBYzRSHAn7" target="_blank" rel="noreferrer" className="hover:text-[#C9A84C] transition-colors duration-200">
                <span className="font-light leading-relaxed text-left inline-block">
                  زهراء المعادي - الشطر العاشر شارع 100 عمارة 27\1,<br />Cairo Governorate 11742
                </span>
              </a>
            </div>
          </div>
          <div className="w-full h-[400px] md:h-[500px] bg-[#111] overflow-hidden border border-white/8">
            <iframe
              title="صالون مصطفي الفا - زهراء المعادي location"
              src="https://maps.google.com/maps?q=%D8%B5%D8%A7%D9%84%D9%88%D9%86+%D9%85%D8%B5%D8%B7%D9%81%D9%8A+%D8%A7%D9%84%D9%81%D8%A7+-+%D8%B2%D9%87%D8%B1%D8%A7%D8%A1+%D8%A7%D9%84%D9%85%D8%B9%D8%A7%D8%AF%D9%8A&amp;hl=en&amp;z=18&amp;output=embed"
              width="100%"
              height="100%"
      ...
      <footer id="contact" className="border-t border-white/6 py-14 bg-[#060606]">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-10">
          <div>
            <p className="text-[#C9A84C] font-display text-lg tracking-[0.1em] uppercase mb-1">
              صالون مصطفي الفا
            </p>
            <p className="text-white/25 text-xs font-light">Zahraa El Maadi, Cairo</p>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <a
              href="tel:01106068486"
        ...
        <div className="max-w-7xl mx-auto px-6 mt-10 pt-6 border-t border-white/5">
          <p className="text-white/20 text-xs" dir="rtl">© 2026 صالون مصطفي الفا - زهراء المعادي. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
